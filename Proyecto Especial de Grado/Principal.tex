...
\titulo{ACTUALIZACIÓN DEL SOFTWARE SISTEMA DE AFORO VEHICULAR MEDIANTE PROCESAMIENTO DIGITAL DE VÍDEO} % Título de su Proyecto Especial de Grado. Este título se utiliza tambien en el resumen
%-------------------------------------------------  
\tutor{EGILDA PEREZ} % Nombre del tutor - Utilizado en una de las portadas y resumen
%-------------------------------------------------   
% En caso de que sea un sólo autor comente los comandos \autorII, \cedulaII y \tlfII
%-------------------------------------------------
\autorI{ANDERSON DIAZ}  % Nombre del 1er autor
\cedulaI{20.480.492}         % C.I del 1er autor
\tlfI{5555-5555555}
\autorII{CRISANTO SANCHEZ} % Nombre del 2do autor 
\cedulaII{22.222.222}        % C.I del 2do autor
\tlfII{6666-6666666}
%-------------------------------------------------
\keywords{AFORO, PROCESAMIENTO,DETECCIÓN} % Palabras Claves - Utilizado en el resumen citado con \keywordnames
%-------------------------------------------------   
\departmento{Electrónica y Comunicaciones de la Escuela de Ingeniería Eléctrica}  % Nombre del Departamento
%-------------------------------------------------                
